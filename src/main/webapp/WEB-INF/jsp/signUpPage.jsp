...
<body>
    ...
    <form class="sign-up" action="main?command=sign-up" method="post">
        ...
        <div class="form-group">
            <label class="sr-only" for="inputConfirmPassword"><fmt:message key="form.confirm-password"/></label>
            <input type="password" name="password" id="inputConfirmPassword" class="form-control" placeholder="<fmt:message key="form.confirm-password"/>" required=""/>
        </div>
        <div class="form-group form-check">
            <input type="checkbox" class="form-check-input" id="rememberCheck">
            <label class="form-check-label" for="rememberCheck"><fmt:message key="form.remember-me"/></label>
        </div>
        <button type="submit" class="btn btn-primary"><fmt:message key="sign-up.button"/></button>
    </form>
